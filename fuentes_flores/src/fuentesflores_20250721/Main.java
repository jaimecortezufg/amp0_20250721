 ...
 */
package fuentesflores_20250721;
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("300 Kelvin a Celsius: " + kelvin_a_celsius() + " C");
        System.out.println("300 Kelvin a Fahrenheit: " + kelvin_a_fahrenheit() + " F");
        System.out.println("300 Kelvin a Rankine: " + kelvin_a_rankine() + " R");
        System.out.println("540 Rankine a Celsius: " + rankine_a_celsius() + " C");
        System.out.println("540 Rankine a Fahrenheit: " + rankine_a_fahrenheit() + " F");
        System.out.println("540 Rankine a Kelvin: " + rankine_a_kelvin() + " K");
    }
