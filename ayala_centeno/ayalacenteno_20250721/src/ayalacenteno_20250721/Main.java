...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("30 Grados Fahrenhei a Celsius: "+fahrenheit_a_celsius()+" C");
        System.out.println("30 Grados Fahrenhei a Kelvin: "+fahrenheit_a_kelvin()+" K");
        System.out.println("30 Grados Fahrenhei a Rankine: "+fahrenheit_a_rankine()+" Ra");
        ...
        System.out.println("20 Grados Kelvin a Rankine: "+kelvin_a_rankine()+" Ra");
        System.out.println("10 Grados Rankine a Celsius: "+rankine_a_celsius()+" C");
        System.out.println("10 Grados Rankine a Farenheit: "+rankine_a_fahrenheit()+" F");
        System.out.println("10 Grados Rankine a Kelvin: "+rankine_a_kelvin()+" K");
    }
